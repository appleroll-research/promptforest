...
### 2.1 Voting Method
We have found that using a Weighted Soft Voting approach is the most simple and effective voting method, ensuring that accurate models have more influence on the final result without drowning out weaker model's voices. We implement Soft Weighted Voting ($S_{w}$) as follows: <br>
...
We measure model "uncertainty" using the Standard Deviation (σ) of all model predictions, scaled and capped at 1.0: <br>
$$U = \min(2\sigma, 1.0)$$
